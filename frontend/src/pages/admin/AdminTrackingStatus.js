  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
        <div className="card">
          <h3 style={{ marginBottom: '1.5rem', color: colors.darkGray }}>Slot Availability</h3>
        ...
        <div className="card">
          <h3 style={{ marginBottom: '1.5rem', color: colors.darkGray }}>Reservation Status</h3>
      ...
      {/* Filter Options */}
      <div className="card" style={{ marginBottom: '2rem' }}>
        <h3 style={{ marginBottom: '1.5rem', color: colors.darkGray }}>Filter Reservations</h3>
      ...
      <div className="card" style={{ marginTop: '2rem' }}>
        <h3 style={{ marginBottom: '1.5rem', color: colors.darkGray }}>Today's Activity</h3>
        <div className="stats-grid">
          <div className="stat-card">
            <div className="stat-number">
