          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <input
              ...
              style={{
                width: '100%',
                padding: '1rem',
                border: `2px solid ${errors.fullName ? colors.red : '#E1E5E9'}`,
                borderRadius: '12px',
                fontSize: '1rem',
              ...
              onBlur={(e) => {
                e.target.style.borderColor = errors.fullName ? colors.red : '#E1E5E9';
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <input
              ...
              style={{
                width: '100%',
                padding: '1rem',
                border: `2px solid ${errors.nicNumber ? colors.red : '#E1E5E9'}`,
                borderRadius: '12px',
                fontSize: '1rem',
                transition: 'all 0.3s ease',
                boxSizing: 'border-box',
              ...
              onBlur={(e) => {
                e.target.style.borderColor = errors.nicNumber ? colors.red : '#E1E5E9';
                e.target.style.boxShadow = 'none';
              }}
            />
            {errors.nicNumber && (
